...
BLOG_AUTHOR = "Pavel Karateev"  # (translatable)
BLOG_TITLE = "Pavel Karateev"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://pavelkarateev.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://pavelkarateev.com/"
BLOG_EMAIL = "karateev.pavel@ya.ru"
BLOG_DESCRIPTION = "Work hard - die Pythonic"  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "pavelkarateev"
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-57414412-1"></script>
<script>
